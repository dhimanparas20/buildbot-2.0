...
def tree (b,rdir):
  return(
    ...
    os.system("cd && cd " + rdir + " && git clone https://github.com/dhimanparas20/vendor_asus.git -b 11 vendor/asus"),
    os.system("cd && cd " + rdir + " && git clone https://github.com/dhimanparas20/device_asus_sdm660-common.git -b 11 device/asus/sdm660-common"),
